...
const setSearch = (state = INITIAL_STATE, { search } : typings.SetSearchAction) => {
  return {
    ...state,
    search,
    page: 1,
...
const setPerPage = (state = INITIAL_STATE, { perPage } : typings.SetPerPageAction) => {
  return {
    ...state,
    perPage,
  }
};
const setOrder = (state = INITIAL_STATE, { sort, dir } : typings.SetOrderAction) => {
  return {
    ...state,
    sort,
    dir
